...
@Suite
struct RadixTypeExtensionsTests {
    @Test
    func radix_TypeExtensions_BinaryInteger() {
    ...
    @Test
    func radix_TypeExtensions_String() {
    ...
    @Test
    func radix_TypeExtensions_StringArray() {
    ...
    @Test
    func radix_TypeExtensions_BinIntCollection() {
    ...
    @Test
    func radix_TypeExtensions_Data() {
