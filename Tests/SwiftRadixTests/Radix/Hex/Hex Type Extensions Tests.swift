...
@Suite
struct HexTypeExtensionsTests {
    @Test
    func hex_TypeExtensions_BinaryInteger() {
        let validString = "7F"
    ...
    @Test
    func hex_TypeExtensions_String() {
        let validValue = 0xFF
    ...
    @Test
    func hex_TypeExtensions_StringArray() {
        let source = ["00", "0xFF"]
    ...
    @Test
    func hex_TypeExtensions_BinIntCollection() {
