...
struct RadixTests {
    ...
    func radix_Init_Integer() throws {
        ...
        let radix2 = try #require(Radix(UInt8(0xFF), base: 8))
    ...
    @Test
    func radix_Init_String() throws {
        // basic init test

        // Int

        let radix1 = try #require(Radix<Int>("0xFF", base: 16))
    ...
    @Test
    func radix_Init_Integer_InvalidRadix() {
    ...
    @Test
    func radix_Init_String_InvalidRadix() {
        // invalid radix (outside 2...36)
    ...
    @Test
    func radix_Init_String_NonStandardRadix() {
        // base-2 is binary; skip testing it here
