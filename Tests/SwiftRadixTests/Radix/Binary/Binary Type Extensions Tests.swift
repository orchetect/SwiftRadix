...
@Suite
struct BinaryTypeExtensionsTests {
    @Test
    func binary_TypeExtensions_BinaryInteger() {
    ...
    @Test
    func binary_TypeExtensions_String() {
    ...
    @Test
    func binary_TypeExtensions_StringArray() {
    ...
    @Test
    func binary_TypeExtensions_BinIntCollection() {
    ...
    @Test
    func binary_TypeExtensions_Data() {
