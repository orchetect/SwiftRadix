...
@Suite
struct OctalTypeExtensionsTests {
    @Test
    func octal_TypeExtensions_BinaryInteger() {
        let validString = "123"
    ...
    @Test
    func octal_TypeExtensions_String() {
    ...
    @Test
    func octal_TypeExtensions_StringArray() {
    ...
    @Test
    func octal_TypeExtensions_BinIntCollection() {
    ...
    @Test
    func octal_TypeExtensions_Data() {
