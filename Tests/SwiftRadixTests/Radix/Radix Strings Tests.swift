...
@Suite
struct RadixStringsTests {
    @Test
    func radix_stringValue_Get() {
        // binary
    ...
    @Test
    func radix_stringValue_Get_Extents() {
        // binary
    ...
    @Test
    func radix_stringValue_Set_Extents() {
        // binary
    ...
    @Test
    func radix_stringValue_Set_Extents_EdgeCases() {
        // binary
    ...
    @Test
    func radix_stringValue_PadTo_EdgeCases() {
    ...
    @Test
    func radix_stringValue_PadTo_SplitEvery() {
        // binary
    ...
    @Test
    func radix_stringValue_PadToEvery() {
        // binary
    ...
    @Test
    func radix_stringValue_PadToEvery_SplitEvery() {
        // binary
